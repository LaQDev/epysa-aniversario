                                ...
                                <div class="file-upload-box multiple-upload" id="drop-zone">
                                    ...
                                    <div class="upload-ui-content" id="upload-ui-content">
                                        ...
                                        <div class="file-meta mt-2">Formatos aceptados: JPG, PNG o MP4. (Máx. 3
                                            archivos)</div>
                                        <div class="file-meta mt-1">Peso máximo por archivo: 200 MB.</div>
                                    </div>
                                </div>
...
<div id="modal-archivo-peso" class="epysa-modal" role="dialog" aria-modal="true" aria-labelledby="modal-peso-titulo">
    ...
    <div class="epysa-modal-container epysa-modal-alert">
        ...
        <p class="modal-alert-desc">El archivo <strong id="modal-peso-filename"></strong> supera el límite permitido de <strong>200 MB</strong>. Por favor selecciona un archivo más liviano.</p>
